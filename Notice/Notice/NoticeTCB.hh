...
extern void TCBwrite_CW(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
...
extern void TCBwrite_DACOFF(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_DACOFF(int sid, unsigned long mid, unsigned long ch); 
...
extern void TCBwrite_DLY(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_DLY(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_AMOREDLY(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_AMOREDLY(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_THR(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_THR(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_POL(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_POL(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PSW(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PSW(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_AMODE(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_AMODE(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PCT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PCT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PCI(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PCI(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PWT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PWT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_DT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_DT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PSS(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PSS(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_RT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_RT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_SR(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_SR(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_DACGAIN(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_DACGAIN(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_TM(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
...
extern void TCBwrite_STLT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_STLT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_ZEROSUP(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_ZEROSUP(int sid, unsigned long mid, unsigned long ch); 
extern void TCBsend_ADCRST(int sid, unsigned long mid); 
extern void TCBsend_ADCCAL(int sid, unsigned long mid); 
extern void TCBwrite_ADCDLY(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
...
extern void TCBwrite_BITSLIP(int sid, unsigned long mid, unsigned long ch, unsigned long data);
...
extern void TCBwrite_ST(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_ST(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_PT(int sid, unsigned long mid, unsigned long ch, unsigned long data); 
extern unsigned long TCBread_PT(int sid, unsigned long mid, unsigned long ch); 
extern void TCBwrite_DRAMDLY(int sid, unsigned long mid, unsigned long ch, unsigned long data);
...
extern unsigned long TCBread_DRAMTEST(int sid, unsigned long mid, unsigned long ch);
...
extern void TCBwrite_HV(int sid, unsigned long mid, unsigned long ch, float data);
...
extern void TCBwrite_ADCMUX(int sid, unsigned long mid, unsigned long ch, unsigned long data);
...
extern int TCBread_DATA(int sid, unsigned long mid, unsigned long bcount, unsigned char *data);
extern void TCB_ADCALIGN_125(int sid, unsigned long mid);
extern void TCB_ADCALIGN_MUONDAQ(int sid, unsigned long mid);
extern void TCBwrite_GAIN(int sid, unsigned long mid, unsigned long ch, unsigned long data);
...
extern void TCBwrite_TRIG_SWITCH_NKFADC500(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long MUONDAQ);
extern unsigned long TCBread_SWITCH_NKFADC500(int sid);
extern void TCBwrite_TRIG_SWITCH_M64ADC_MUON(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls,  unsigned long MUONDAQ);
extern unsigned long TCBread_SWITCH_M64ADC_MUON(int sid);
extern void TCBwrite_TRIG_SWITCH_M64ADC_LS(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long MUONDAQ);
extern unsigned long TCBread_SWITCH_M64ADC_LS(int sid);
extern void TCBwrite_TRIG_SWITCH_MUONDAQ(int sid, unsigned long fadc, unsigned long sadc_muon, unsigned long sadc_ls, unsigned long MUONDAQ);

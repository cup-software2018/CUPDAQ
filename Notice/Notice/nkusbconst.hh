...
#define CMD_CY_FX_SPI_FLASH_STATUS                (0)
#define CMD_CY_FX_SPI_FLASH_ERASE                 (1)
#define CMD_CY_FX_SPI_FLASH_WRITE                 (2)
#define CMD_CY_FX_SPI_FLASH_READ                  (3)
#define CMD_CY_FX_FPGA_WRITE                      (4)
#define CMD_CY_FX_ADC_GPIO_READ                   (5)
